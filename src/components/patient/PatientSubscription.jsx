...
const PatientSubscription = () => {
    return (
        <div className="p-5">
            ...
            <div className="flex flex-col md:flex-col lg:flex-row gap-10 lg:mt-10">
                ...
                <div className="bg-gradient-to-l from-sky-500 to-sky-300 p-3 rounded-md mx-4 scale-110">
                    ...
                    <div className="flex justify-center mt-4">
                        <button className="p-2 rounded w-full bg-gray-200 hover:bg-gray-50 transition-colors">Buy Now</button>
                    </div>
                </div>
