...
export function ChatWithBloomBtn(props) {
  return (
    <div className="flex right-1 bottom-1 fixed rounded-lg md:bg-gradient-to-r md:from-[#6355BC] md:to-[#2D2756]" onClick={props.toggle}>
