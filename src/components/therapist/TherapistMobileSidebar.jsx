...
const TherapistMobileSidebar = (props) => {
    ...
    return (
        ...
        <div className="bg-neutral-300 dark:bg-neutral-800 rounded-lg w-full p-4 relative overflow-auto">
            ...
            <div className="flex flex-col my-5 border-b-2 dark:border-neutral-900">
                ...
                <p className="text-neutral-600 dark:text-neutral-400 capitalize">{props?.data?.role}</p>
...
export default TherapistMobileSidebar