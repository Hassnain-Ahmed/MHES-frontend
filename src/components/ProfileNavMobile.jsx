...
const ProfileNavMobile = (props) => {
    ...
    return (
        <div className="bg-[#eee] rounded-lg p-5 border-2 relative dark:bg-gray-800 dark:border-gray-800 dark:text-white">
            ...
            <div className="absolute right-0 top-0 ml-[-10px]">
            ...
            {/* <input type="checkbox" value={"light"} checked={themeMode == 'dark'} onChange={themeOnChange} /> */}

            <div>
                <img src={props.profilePic} alt="Profile" className={`border-2 w-[80px] h-[80px] rounded-[100%] dark:bg-neutral-400 ${props.imgClass}`} />
            </div>
            <div>
