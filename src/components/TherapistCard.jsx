...
export function TherapistCard(props) {
  ...
  return (
    <div
      className="border-2 rounded-xl m-2 relative lg:w-[22%] md:w-[45%] w-[100%] hover:cursor-pointer overflow-hidden"
      key={props.id}
    >
      <div>
      ...
      <div className="md:px-4 p-2 absolute rounded-md bottom-0 bg-[#fff] w-full">
